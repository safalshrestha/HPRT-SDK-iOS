 ...
 */
- (bool) PageBegin:(int)startx starty:(int)starty width:(int)width height:(int)height rotate:(int)rotate;
 ...
 *            字符串数据流
 */
- (bool) DrawPlainText:(int)startx starty:(int)starty font:(int)font style:(int)style str:(char *)str;
 ...
 */
- (bool) DrawLine:(int)startx starty:(int)starty endx:(int)endx endy:(int)endy width:(int)width color:(int)color;
 ...
 */
- (bool) DrawBox:(int)left top:(int)top right:(int)right bottom:(int)bottom borderwidth:(int)borderwidth bordercolor:(int)bordercolor;
 ...
 */
- (bool) DrawRectangel:(int)left top:(int)top right:(int)right bottom:(int)bottom color:(int)color;
 ...
 *            文本字符数据流
 */
- (bool) DrawBarcode:(int)startx starty:(int)starty type:(int)type height:(int)height unitwidth:(int)unitwidth rotate:(int)rotate str:(char *)str;
 ...
 *            QRCode 文本字符数据流
 */
- (bool) DrawQRCode:(int)startx starty:(int)starty version:(int)version ecc:(int)ecc unitwidth:(int)unitwidth rotate:(int)rotate str:(char *)str;
 ...
 *            PDF417 文本字符数据流。
 */
- (bool) DrawPDF417:(int)startx starty:(int)starty colnum:(int)colnum lwratio:(int)lwratio ecc:(int)ecc unitwidth:(int)unitwidth rotate:(int)rotate str:(char *)str;
 ...
 *            位图的点阵数据。
 */
- (bool) DrawBitmap:(int)startx starty:(int)starty width:(int)width height:(int)height style:(int)style pdata:(Byte *)pdata;

- (bool) DrawBitmap:(int)startx starty:(int)starty width:(int)width height:(int)height style:(int)style img:(UIImage *)img nBinaryAlgorithm:(int)nBinaryAlgorithm;
