...
- (int)printContent
{
    ...
    [myApp.myPos POS_PrintPicture:img x:-1 nWidth:384 nHeight:644 nBinaryAlgorithm:0 nCompressMethod:2];
    [myApp.myPos POS_PrintPicture:img x:-2 nWidth:384 nHeight:644 nBinaryAlgorithm:0 nCompressMethod:2];
    [myApp.myPos POS_PrintPicture:img x:-3 nWidth:384 nHeight:644 nBinaryAlgorithm:0 nCompressMethod:2];
